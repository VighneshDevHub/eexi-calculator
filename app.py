...
from calculators.pipe_wall import calculate_pipe_wall, MATERIAL_LABELS, WELD_LABELS
...
from api.calculators import calculators_bp
from api.constants import constants_bp
...
# @app.route('/pipe')
# def pipe_page():
#     from calculators.pipe_wall import NPS_DEXT_MM, MATERIAL_LABELS, WELD_LABELS
